...
export function Footer({ locale, dict }: { locale: Locale; dict: Dictionary }) {
  ...
  return (
    <footer className="text-cream-100">
      ...
      <div className="texture-grain -mt-px bg-khaki-800">
        <Container className="py-16">
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
                ...
                <div className="mt-6 flex gap-2">
                  {socials.map(({ href, Icon, label }) => (
                    <a
                      ...
                      aria-label={label}
                      className="inline-flex h-10 w-10 items-center justify-center rounded-full ring-1 ring-cream-100/20 transition-colors hover:bg-cream-100/10"
                    >
                ...
                {footerNavigation.map((item) => (
                  <li key={item.key}>
                    <Link
                      ...
                      className="text-cream-100/70 transition-colors hover:text-ochre-300"
                    >
            ...
            <div>
              ...
              <ul className="space-y-3.5 text-sm text-cream-100/70">
          ...
          <div className="mt-14 border-t border-cream-100/15 pt-8">
            <VisitorStats
              labels={{
            ...
            <div className="flex flex-col gap-4 text-xs text-cream-100/50 sm:flex-row sm:items-center sm:justify-between">
              <p>
