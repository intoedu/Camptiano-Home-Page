...
export const site = {
   ...
   * 대표님 사진 — 소개·인사말의 서명 옆.
   *
   * 받은 원본은 밤에 찍은 작은 사진(540×960)이라, 얼굴 부분만 남기면
   * 230×288 밖에 되지 않습니다. 크게 걸면 흐려지므로 서명 옆에 작게 둡니다.
   * 낮에 찍은 상반신 사진이 오면 이 파일을 바꾸고 크기를 키우면 됩니다.
   */
  representativePhoto: "/people/representative.jpg",
